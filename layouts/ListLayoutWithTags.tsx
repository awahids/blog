              ...
              {displayPosts.map((post) => {
                ...
                return (
                  <li key={path} className="py-5">
                    <article className="transform·flex-col·space-y-2·rounded·p-2·transition-transform·hover:scale-105·hover:bg-gray-100·dark:hover:bg-gray-900·xl:col-span-3">
                      <Link
                        href={`/${path}`}
