  ...
  return (
    <>
      <div className="container">
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-0DJCD80RNK"></script>
        <script id="google-analytics">
          {`window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-0DJCD80RNK');`}
        </script>
      </div>
              ...
              <li key={slug} className="py-12">
                <article>
                  <div className="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
                    ...
                    <div className="flex transform space-y-5 rounded p-2 transition-transform hover:scale-105 hover:bg-gray-100 dark:hover:bg-gray-900 xl:col-span-3">
                      <Link
                        href={`/blog/${slug}`}
