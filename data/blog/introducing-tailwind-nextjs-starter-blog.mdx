...
- [Demo Blog](https://blog.awahids.my.id/) - this repo
...
- [A markdown guide](https://blog.awahids.my.id/blog/github-markdown-guide)
- [Learn more about images in Next.js](https://blog.awahids.my.id/blog/guide-to-using-images-in-nextjs)
- [A tour of math typesetting](https://blog.awahids.my.id/blog/deriving-ols-estimator)
- [Simple MDX image grid](https://blog.awahids.my.id/blog/pictures-of-canada)
- [Example of long prose](https://blog.awahids.my.id/blog/the-time-machine)
- [Example of Nested Route Post](https://blog.awahids.my.id/blog/nested-route/introducing-multi-part-posts-with-nested-routing)
...
authors: ['default', 'sparrowhawk']
layout: PostLayout
canonicalUrl: https://blog.awahids.my.id/blog/introducing-tailwind-nextjs-starter-blog
---
```
